...
const features = [
  {
    ...
    description:
      "Every pixel is intentional. We design unique interfaces that reflect your brand and guide users toward action.",
  },
  {
    icon: Smartphone,
    title: "Mobile-First Responsive",
    description:
      "Designed for mobile first, then scaled up. Your site looks flawless on every screen size and device.",
  },
  {
    icon: MousePointerClick,
    title: "Landing Pages & Funnels",
    description:
      "High-converting landing pages and multi-step funnels built to capture leads and close sales.",
  },
  {
    icon: ShoppingCart,
    title: "E-Commerce Solutions",
    description:
      "From product catalogs to checkout flows, we build online stores that make buying effortless.",
  },
  {
    icon: Zap,
    title: "Performance Optimization",
    description:
      "Sub-2-second load times, Core Web Vitals optimization, and lightning-fast page transitions.",
  },
  {
    icon: Layers,
    title: "CMS Integration",
    description:
      "WordPress, Shopify, Webflow, or headless CMS — we integrate whatever platform fits your workflow.",
  },
];
...
const process = [
  {
    ...
    title: "Discovery",
    description:
      "We learn your business, audience, competitors, and goals through in-depth research and stakeholder interviews.",
  },
  {
    step: "02",
    title: "Design",
    description:
      "Wireframes, mood boards, and high-fidelity mockups delivered for your feedback and approval.",
  },
  {
    step: "03",
    title: "Develop",
    description:
      "Pixel-perfect development with responsive layouts, animations, SEO foundations, and CMS setup.",
  },
  {
    step: "04",
    title: "Launch",
    description:
      "QA testing, performance audits, and a smooth go-live with post-launch monitoring and support.",
  },
];
...
const faqs = [
  {
    ...
    a: "A typical website project takes 4 to 8 weeks from kickoff to launch, depending on complexity. Simple landing pages can be done in 1 to 2 weeks, while larger e-commerce or multi-page sites may take 8 to 12 weeks. We provide a detailed timeline during discovery.",
  },
  {
    q: "What technologies do you use?",
    a: "We work with modern frameworks like Next.js, React, and Tailwind CSS for custom builds, plus WordPress, Shopify, and Webflow for CMS-driven sites. We recommend the best stack based on your specific needs, budget, and long-term goals.",
  },
  {
    q: "How many design revisions are included?",
    a: "Our standard packages include two rounds of revisions at each major design milestone. We find that our collaborative process, with regular check-ins and shared design files, usually gets us to the final design faster than a rigid revision count.",
  },
  {
    q: "Do you offer ongoing maintenance?",
    a: "Yes. We offer monthly maintenance plans that include security updates, content changes, performance monitoring, and priority support. Many of our clients pair website design with our hosting service for a fully managed solution.",
  },
];
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <Reveal>
                <p className="text-sm font-semibold uppercase tracking-widest text-[#F97316]">
                  UI/UX &middot; Mobile-First &middot; Funnels &middot; E-Commerce
                </p>
              </Reveal>
              <Reveal delay={0.1}>
              ...
              <Reveal delay={0.2}>
                <p className="mt-6 max-w-xl text-lg text-[#9CA3AF] leading-relaxed">
                  We design and build fast, beautiful, mobile-first websites that
                  turn traffic into revenue. Every project is custom — no
            ...
            <Reveal delay={0.3} className="hidden lg:block">
              <div className="rounded-xl overflow-hidden border border-white/[0.06]">
                <img src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=1200&q=90" alt="Website design on multiple devices" className="w-full h-auto object-cover" />
              </div>
            </Reveal>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Reveal delay={0.1}>
            <p className="mt-4 text-[#9CA3AF] max-w-xl mx-auto">
              Get a free project consultation and see how a custom website can
